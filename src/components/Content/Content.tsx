...
const Content: Component = () => {
  ...
  return (
    <section class={'absolute w-full h-full z-10 flex justify-center items-center'}>
      ...
      <For each={state.assets} fallback={<p>Loading...</p>}>{ asset => {
        ...
        return (
          ...
          <iframe
            ...
            onLoad={(e) => {
              // TODO Patch store
              // console.log('asset', (asset.data?.params as any)['count'].name, (asset.data?.params as any)['count'].min);
